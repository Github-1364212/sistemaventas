...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Panel</a></li>
            <li class="breadcrumb-item active" aria-current="page">Listado de Asistencia</li>
        </ol>
    </nav>
</div>
<div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row grid-margin">
                    <div class="col-12">
                        <a href="{{route('take.attendence')}}" type="button" class="btn btn-primary btn-fw"><i class="fas fa-hand-paper"></i> Tomar Ahora</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <table id="order-listing" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->edit_date}}</td>
                                        <td class="text-right">
                                            <a href="{{URL::to('/edit-attendence/'.$row->edit_date)}}" class="btn btn-light">
                                                <i class="fa fa-edit text-dark"></i> Editar
                                            </a>
                                            <a href="{{URL::to('/delete-attendence/'.$row->edit_date)}}" id="delete" class="btn btn-light">
                                                <i class="fa fa-times text-danger"></i> Eliminar
                                            </a>
                                            <a href="{{URL::to('/view-attendence/'.$row->edit_date)}}" class="btn btn-light">
