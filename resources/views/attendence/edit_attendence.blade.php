...
@section('title', 'Actualizar asistencia')
...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Actualizar asistencia</li>
        </ol>
    </nav>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Actualizar Asistencia {{$date->att_date}}</h4>
                <div class="row">
                    <div class="col-12">
                        <form action="{{url('/update-attendence')}}" method="POST">
                                            ...
                                            <td>
                                                <div class="form-check form-check-flat form-check-primary">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="attendence[{{$row->id}}]" value="Presente" required="" <?php if ($row->attendence == 'Presente') {
                                                                                                                                                                        echo "checked";
                                                                                                                                                                    } ?>>
                                                        Presente
                                                ...
                                                <div class="form-check form-check-flat form-check-primary">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="attendence[{{$row->id}}]" value="Ausente" <?php if ($row->attendence == 'Ausente') {
                                                                                                                                                            echo "checked";
                                                                                                                                                        } ?>>
                                                        Ausente
                                                        <i class="input-helper"></i></label>
                            ...
                            <button type="submit" class="btn btn-success btn-rounded btn-fw">Actualizar Asistencia</button>
                        </form>
                    </div>
                </div>
            </div>
