...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>Agregar Categoria</span></li>
        </ol>
    </nav>
</div>
<div class="row">
            ...
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{url('insert-category')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="cat_name" class="form-control" id="exampleInputPassword4" placeholder="Nombre" required>
                    </div>
                    <div class="form-group">
                    </div>
