...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>Listado de Clientes</span></li>
        </ol>
    </nav>
</div>
<div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row grid-margin">
                    <div class="col-12">
                        <a href="{{route('add.customer')}}" type="button" class="btn btn-primary btn-fw"><i class="fa fa-plus-square"></i> Agregar Nuevo</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <table id="order-listing" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->city}}</td>
                                        <td class="text-right">
                                            <a href="{{URL::to('edit-customer/'.$row->id)}}" class="btn btn-light">
                                                <i class="fa fa-edit text-dark"></i> Editar
                                            </a>
                                            <a href="{{URL::to('view-customer/'.$row->id)}}" class="btn btn-light">
                                                <i class="fa fa-eye text-primary"></i> Ver
                                            </a>
                                            <a href="{{URL::to('delete-customer/'.$row->id)}}" id="delete" class="btn btn-light">
