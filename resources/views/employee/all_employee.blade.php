        ...
        <div class="card">
            <div class="card-body">
                <div class="row grid-margin">
                    <div class="col-12">
                        <a href="{{route('add.employee')}}" type="button" class="btn btn-primary btn-fw"><i class="fa fa-plus-square"></i> Agregar Nuevo</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <table id="order-listing" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->salary}}</td>
                                        <td class="text-right">
                                            <a href="{{URL::to('edit-employee/'.$row->id)}}" class="btn btn-light">
                                                <i class="fa fa-edit text-dark"></i> Editar
                                            </a>
                                            <a href="{{URL::to('view-employee/'.$row->id)}}" class="btn btn-light">
                                                <i class="fa fa-eye text-primary"></i> Ver
                                            </a>
                                            <a href="{{URL::to('delete-employee/'.$row->id)}}" id="delete" class="btn btn-light">
