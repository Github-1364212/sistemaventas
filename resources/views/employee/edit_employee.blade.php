...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>Actualizar Empleado</span></li>
        </ol>
    </nav>
</div>
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="forms-sample" action="{{url('/update-employee/'.$edit->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="experience" class="form-control" id="exampleInputPassword4" value="{{$edit->experience}}" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">DNI</label>
                        <input type="text" name="nid_no" class="form-control" id="exampleInputPassword4" value="{{$edit->nid_no}}" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">Salario</label>
                        <input type="text" name="salary" class="form-control" id="exampleInputPassword4" value="{{$edit->salary}}" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">Vacaciones</label>
                        <input type="text" name="vacation" class="form-control" id="exampleInputPassword4" value="{{$edit->vacation}}" required>
                    </div>
                    <div class="form-group">
