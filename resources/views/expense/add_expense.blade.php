...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>Agregar Gasto</span></li>
        </ol>
    </nav>
</div>
<div class="row">
            ...
            <div class="card-body">
                <div class="form-group">
                    <div class="template-demo">
                        <a href="{{route('today.expense')}}" type="button" class="btn btn-primary btn-fw"><i class="fas fa-sun"></i> Hoy Día</a>
                        <a href="{{route('monthly.expense')}}" type="button" class="btn btn-success btn-fw"><i class="fas fa-calendar"></i> Este Mes</a>
                    </div>
                ...
                @endif
                <form class="forms-sample" action="{{url('insert-expense')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="exampleInputName1">Detalles</label>
                        <textarea class="form-control" id="exampleTextarea1" name="details" rows="4" placeholder="Detalles"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail3">Monto (S/.)</label>
                        <input type="text" name="amount" class="form-control" id="exampleInputEmail3" placeholder="Monto" required>
                    </div>
                    <div class="form-group">
