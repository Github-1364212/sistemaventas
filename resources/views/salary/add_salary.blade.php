...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>Agregar Salario</span></li>
        </ol>
    </nav>
</div>
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="forms-sample" action="{{url('insert-salary')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="year" class="form-control" id="exampleInputPassword4" placeholder="Año" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">Pago (S/.)</label>
                        <input type="text" name="advanced_salary" class="form-control" id="exampleInputPassword4" placeholder="salario" required>
                    </div>
                    <div class="form-group">
                    </div>
