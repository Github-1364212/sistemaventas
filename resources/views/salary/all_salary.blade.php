...
@section('title', 'Listado de Salarios')
...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Panel</a></li>
            <li class="breadcrumb-item active" aria-current="page">Listado de Salarios</li>
        </ol>
    </nav>
</div>
<div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row grid-margin">
                    <div class="col-12">
                        <a href="{{route('add.salary')}}" type="button" class="btn btn-primary btn-fw"><i class="fa fa-plus-square"></i> Agregar Nuevo</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <table id="order-listing" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="{{URL::to('edit-salary/'.$row->id)}}" class="btn btn-light">
                                                <i class="fa fa-edit text-dark"></i> Editar
                                            </a>
                                            <a href="{{URL::to('view-salary/'.$row->id)}}" class="btn btn-light">
                                                <i class="fa fa-eye text-primary"></i> Ver
                                            </a>
                                            <a href="{{URL::to('delete-salary/'.$row->id)}}" id="delete" class="btn btn-light">
