...
@section('title', 'Visualizar Proveedor')
...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>Visualizar Proveedor</span></li>
        </ol>
    </nav>
</div>
<div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <form class="forms-sample">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword4">Tipo</label>
                        <input type="text" name="type" class="form-control" id="exampleInputPassword4" value="{{$single->type}}" required readonly>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">Nombre de tienda</label>
                        <input type="text" name="shop" class="form-control" id="exampleInputPassword4" value="{{$single->shop}}" required readonly>
                    </div>
                    <div class="form-group">
